  ...
  const panResponder = PanResponder.create({
    ...
    onPanResponderMove: (evt, gestureState) => {
      if (zoomLevel > 1) {
        ...
        // Y LIMIT
        if (newTranslateY > maxTranslateY.current) newTranslateY = maxTranslateY.current;
        if (newTranslateY < minTranslateY.current) newTranslateY = minTranslateY.current;
    ...
    onPanResponderRelease: (evt, gestureState) => {
      ...
      if (lastTranslateY.current < minTranslateY.current) lastTranslateY.current = minTranslateY.current;
