...
// Import your new MainHeader component (Adjust the path based on your folder structure)
...
export default function AddMoneytoWallet({ visible, onClose, navigation }) {
  ...
  return (
      <SafeAreaView style={styles.container}>
        ...
        {/* Replaced hardcoded header with MainHeader component */}
        <MainHeader 
          ...
          <LinearGradient colors={['#6366F1', '#4F46E5']} style={styles.balanceCard}>
            <View style={styles.balanceCardLeft}>
              <View style={styles.balanceRow}>
                ...
                {/* CHANGED: Wrapped in TouchableOpacity to toggle visibility */}
                <TouchableOpacity 
              ...
              <Text style={styles.cryptoBalance}>
                {isBalanceVisible ? (walletData?.balance?.toLocaleString() || '0') : '****'}{' '}
                <Text style={styles.tokenTicker}>PAYO</Text>
              </Text>
              {/* CHANGED: Dynamic fiat display */}
              <Text style={styles.fiatBalance}>
                {isBalanceVisible ? `≈ ₹${(walletData?.balance * 0).toLocaleString() || '0'}` : '≈ ₹****'}
              </Text>
            </View>
